  ...
  return (
    ...
    >
      <div
        ...
        className="h-96  backdrop-blur rounded-lg w-full max-w-3xl mx-auto overflow-y-scroll shadow-xl cursor-text font-mono"
      >
        <TerminalHeader />
...
const TerminalHeader = () => {
  return (
    <div className="w-full p-3 flex items-center gap-1 sticky top-0">
